...
#This code was given by the course. I am not the author.
...
figure(1)
semilogx(simulated_mRNA_concentration[:,1],simulated_mRNA_concentration[:,2],color=color1,lw=2)
...
#figure()
#semilogx(simulated_mRNA_concentration[:,1],simulated_mRNA_concentration[:,3],color=color1,lw=2)

# label the axes -
#xlabel("Inducer [mM]",fontsize=16)
#label("u (dimensionless)",fontsize=16)
