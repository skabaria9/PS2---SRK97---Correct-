...
figure(figsize=(4*10,3*10))
figure(3)
plot(t,m1_gDW,color="black")
plot(t,m2_gDW,color="blue")
plot(t,m3_gDW,color="red")
xlabel("time (min)")
ylabel("mRNA Concentration (umol/gDW)")

#uncomment the following line to overlay with 2c
#include("srk_ps2_2c.jl")
